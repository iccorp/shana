...
import fr.iccorp.shana.domain.Message;
import fr.iccorp.shana.repository.MessageRepository;
import fr.iccorp.shana.service.MessageService;
import fr.iccorp.shana.service.dto.MessageDTO;
import fr.iccorp.shana.service.mapper.MessageMapper;
...
public class MessageResourceIntTest {
    ...
    public void createMessage() throws Exception {
        ...
        assertThat(testMessage.getObjet()).isEqualTo(DEFAULT_OBJET);
    ...
    public void updateMessage() throws Exception {
        ...
        Message testMessage = messageList.get(messageList.size() - 1);
        assertThat(testMessage.getObjet()).isEqualTo(UPDATED_OBJET);
