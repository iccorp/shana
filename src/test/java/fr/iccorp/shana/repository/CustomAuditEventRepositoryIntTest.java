...
import fr.iccorp.shana.config.audit.AuditEventConverter;
import fr.iccorp.shana.domain.PersistentAuditEvent;
...
import static fr.iccorp.shana.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
