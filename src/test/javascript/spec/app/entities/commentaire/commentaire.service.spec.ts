...
describe('Service Tests', () => {
    ...
    describe('Commentaire Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(CommentaireService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/commentaires/' + 123);
            });
            it('should return Commentaire', () => {

                let entity: Commentaire;
                service.find(123).subscribe((_entity: Commentaire) => {
                    entity = _entity;
                });
