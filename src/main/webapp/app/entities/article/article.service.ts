...
export class ArticleService {
    ...
    private convertItemFromServer(json: any): Article {
        ...
        entity.dateDerniereModification = this.dateUtils
            .convertDateTimeFromServer(json.dateDerniereModification);
        return entity;
    }
    ...
    private convert(article: Article): Article {
        ...
        copy.dateCreation = this.dateUtils.toDate(article.dateCreation);

        copy.dateDerniereModification = this.dateUtils.toDate(article.dateDerniereModification);
        return copy;
    }
}
